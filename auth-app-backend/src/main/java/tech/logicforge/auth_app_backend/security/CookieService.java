...
public class CookieService {
    ...
    // Clear refresh cookie if user logout
    ...
    public void attachAccessCookie(HttpServletResponse response, String accessToken, int maxAgeSeconds) {
    ...
    //  shared network caches never to save copies of this sensitive authentication response
